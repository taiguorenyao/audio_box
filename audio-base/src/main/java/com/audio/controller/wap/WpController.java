...
public class WpController
{
    ...
    public String addAudio(Model model,PersonAviEvt data, HttpServletRequest req)
    {
...
//                        personAdEvt);
            ...
            Integer pageSize)
    {
        ...
        List<BoxUser> uidlist = (List<BoxUser>)userService.loadAllDate(8,boxUser.getAccount());
        ...
        if (uidlist != null)
        {
            ...
            String startTime = DateTimeUtil.getNow(DateTimeUtil.FORMAT_SHORT)+" 00:00:00";
            String endTime = DateTimeUtil.getNow(DateTimeUtil.FORMAT_SHORT)+" 23:59:59";
