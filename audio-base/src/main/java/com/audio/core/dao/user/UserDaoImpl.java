...
public class UserDaoImpl implements UserDao
{
    ...
    public Object loadDate(int type, Object... s)
    {
        ...
        if (11 == type)
        {
            Map<String, Object> map = StringUtil.getParamMap("code",
                    (String)s[0]);
            return sqlSession.selectOne("User.getUserBymdcode",map);
        }
    ...
    public int updateObjectData(int type, Object... s)
    {
        ...
        if (28 == type)
        {
            return sqlSession.update("User.updateBoxUserMdCode", (BoxUser) s[0]);
        }
            ...
            String... str)
    {
        ...
        {
            Map<String, Object> map = new HashMap<String, Object>();
            map.put("account", str[0]);
            return sqlSession.selectList("User.getUidByAccount",
                    map);
        }
