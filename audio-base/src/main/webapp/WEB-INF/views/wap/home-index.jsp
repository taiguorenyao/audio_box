...
<ul class="list-group m-t-sm list-user">
    ...
    <li class="list-group-item"><a href="/wp/clicklist"><span class="iconfont icon-location pull-left"></span>下线流量统计<span class="iconfont icon-right pull-right"></span></a></li>
