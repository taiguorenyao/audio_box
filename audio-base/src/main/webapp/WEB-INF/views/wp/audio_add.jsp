...
<section class="container" id="form-register">
    ...
    <form method="post" class="form-x" action="/wp/addAudiodo">
        ...
        <div class="form-group">
            ...
            <c:if test="${disabled_mp4 eq '1'}">
                <input type="radio" id="types1" name="types" value="0" disabled/>MP4(禁止上传)|
                <input type="radio" id="types2" name="types" value="1" checked/>ifarme
            </c:if>
            <c:if test="${disabled_mp4 ne '1'}">
