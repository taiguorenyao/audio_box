...
<body style="background-image: url('/static/images/user_login_bg.jpg');background-attachment: fixed;background-repeat: no-repeat;background-size: cover;">
<div class="container">
    <div class="line">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="/login/logindo" id="loginForm" method="post">
                <div class="panel">
                    ...
                    <div class="panel-foot text-center"><a href="/login/userreg">注册</a></div>
